...
```{r xseeds_future_map, eval=FALSE, include=FALSE}
library(furrr)
library(tictoc)
...
iterative_run_ml_results <- future_map(1:5, get_hp_results,
                                       .options = furrr_options(seed=TRUE), .progress = TRUE)
toc()

saveRDS(iterative_run_ml_results, file = "data/model_training_results.rds")
save(iterative_run_ml_results, file = "data/model_training_results.rda")

plan("sequential") # Back to single sequencer
```
